...
export const GENERAL_QUESTIONS = [
  ...
  'HMTC semakin besar dari tahun ke tahun dimana jumlah mahasiswa yang banyak juga dibarengi dengan kebutuhan mahasiswa yang semakin diverse dan memaksa himpunan untuk terus berkembang menyesuaikan relvansinya. Dalam pandanganmu, untuk menyikapi permasalahan ini, langkah apa yang harus HMTC lakukan untuk merelevansikan dirinya di tengah kebutuhan yang semakin meluas dan diverse?',
  'RUMJ (Rapat Umum Mahasiswa Jurusan) merupakan forum terbuka bagi warga Teknik Informatika untuk memutuskan perkara yang berkaitan dengan HMTC. Namun partisipasi seringkali rendah sehingga kuorum tidak tercapai. Menurut Anda, siapa yang bertanggung jawab atas permasalahan ini dan langkah apa yang sebaiknya diambil untuk meningkatkan partisipasi warga pada RUMJ?',
] as const;
