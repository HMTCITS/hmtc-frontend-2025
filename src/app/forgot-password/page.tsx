    ...
    <AuthLayout>
      ...
      {isSubmitted ? (
        <div className="space-y-6 font-primary">
          <Typography>
            Anda akan menerima tautan di email yang Anda berikan dan memungkinkan Anda memverifikasi resmi akun Anda.
          </Typography>
          <Typography variant="h4">example.test@gmail.com</Typography>
          <Typography>
            Jika Anda tidak melihat email tersebut, periksa tempat lain yang mungkin ada, seperti folder sampah, spam, sosial, atau lainnya.
          </Typography>
          <Typography>
