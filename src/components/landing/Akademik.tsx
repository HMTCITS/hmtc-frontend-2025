...
const Akademik = () => {
  ...
  return (
    <section className='relative flex h-fit w-full justify-center overflow-hidden bg-blue-main px-6 text-white'
    style={{
      ...
      <Typography
        ...
        >
          <span className='font-satoshi font-light text-3xl md:text-4xl lg:text-5xl'>“</span>
        ...
        >
          ...
          <span className='font-adelphe font-light text-3xl md:text-4xl lg:text-5xl'>”</span>
        </Typography>
        ...
        <Typography
          ...
          style={{ marginBottom: 0, marginTop: 100, lineHeight: '1.2' }} /* Atur margin dan line-height */
        >
        ...
        <Typography
          ...
          style={{ marginTop: 6, lineHeight: '1.2', opacity: 0.68 }} /* Atur margin dan line-height */
        >
          Ketua HMTC 2024
        </Typography>
      </main>
